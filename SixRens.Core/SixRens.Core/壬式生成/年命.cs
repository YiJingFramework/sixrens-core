...
namespace SixRens.Core.壬式生成
{
    ...
    {
        private static EarthlyBranch 判断行年(性别 性别, EarthlyBranch 本命, EarthlyBranch 当前年)
        {
            if (性别.为男性)
            {
                const int 寅数 = 3;
        ...
        public 年命(性别 性别, EarthlyBranch 本命, I年月日时 年月日时)
            : this(性别, 本命, 判断行年(性别, 本命, 年月日时.年支))
        { }

        public 年命(性别 性别, EarthlyBranch 本命, I年月日时信息 年月日时)
            : this(性别, 本命, 判断行年(性别, 本命, 年月日时.年支)) 
        { }
    }
}
