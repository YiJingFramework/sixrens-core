...
namespace SixRens.Core.年月日时
{
    public static class 年月日时扩展
    {
        ...
        public static I年月日时信息 修改时间(this I年月日时信息 年月日时信息,
            EarthlyBranch 时支, HeavenlyStem 指定时干)
        {
            return new 自由年月日时(
                年月日时信息.年干, 年月日时信息.年支, 年月日时信息.月干, 年月日时信息.月支,
                年月日时信息.日干, 年月日时信息.日支, 指定时干, 时支,
                年月日时信息.昼占, 年月日时信息.月将);
        }

        public static I年月日时信息 修改时间(this I年月日时信息 年月日时信息,
            EarthlyBranch 时支, bool 修正时干 = true)
        {
            var 可验 = new 可检验年月日时(
                年月日时信息.年干, 年月日时信息.年支, 年月日时信息.月支,
                年月日时信息.日干, 年月日时信息.日支, 时支,
                年月日时信息.昼占, 年月日时信息.月将);
            return new 自由年月日时(
                年月日时信息.年干, 年月日时信息.年支, 年月日时信息.月干, 年月日时信息.月支,
                年月日时信息.日干, 年月日时信息.日支, 可验.时干, 时支,
                年月日时信息.昼占, 年月日时信息.月将);
        }
